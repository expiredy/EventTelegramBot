...
class DatabaseClient:
    ...
    def get_user_by_username(self, searching_username: str) -> int:
        return self.database_cursor.execute(f"""SELECT username, telegram_id 
                                                FROM {USERS_DATABASE_NAME}
                                                WHERE username = {searching_username}""").fetchall()
...
if __name__ == "__main__":
    ...
    print(test_database.get_user_by_username("NikitaTeletov"))
